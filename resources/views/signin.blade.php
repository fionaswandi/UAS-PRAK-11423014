    ...
    <div class="col-md-9 m-auto">
      <div class="row mt-5">
        <div class="col-md-7 mt-5">
          <img src="{{asset('assets/images/welcome.jpg')}}" class="img-fluid animated flipInX">          
        </div>
        <div class="col-md-5 mt-5 animated flipInX">
          <div class="clearfix" 
            style="margin-top:40px">
            <div class="float-left">
              <b>Masuk ke akun sekarang juga<b>
            </div>
          ...
          <form class="mt-4" method="post" action="{{route('signin')}}" id="form-signin">
            ...
            <div class="form-group">
              <a href="{{route('signup')}}">Belum punya akun? Tekan Disini</a>
            </div>
          </form>
        </div>
      </div>
